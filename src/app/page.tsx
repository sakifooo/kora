...
export default function Home() {
  const matches = [
    { teamA: "نيجيريا", teamB: "البرتغال", scoreA: 0, iscoreB: 0, time: "20:45 ", start: "start", channel: "Bein Sports HD2 ", commentator: "غير معروف", league: "ودية دولية ", href: "/live/nigeria-vs-portugal" },
