...
export default function Home() {
  ...
  const matches = [
    ...
    { teamA: "فرنسا", teamB: "العراق", scoreA: 2, scoreB: 0, time: "22:00", status: "live", channel: "beIN SPORTS MAX 1", commentator: "غير معروف", league: "كأس العالم", href: "/live/france-vs-iraq" },
