...
export default function Home() {
  const matches = [
    { teamA: "نيجيريا", teamB: "البرتغال", scoreA: 2, scoreB: 0, time: "20:45 ", status: "upcoming", channel: "Bein Sports HD2 ", commentator: "غير معروف", league: "ودية دولية ", href: "/live/nigeria-vs-portugal" },
