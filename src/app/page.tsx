...
export default function Home() {
  ...
  const matches = [
    { teamA: "الأرجنتين", teamB: "النمسا", scoreA: 1, scoreB: 0, time: "18:00", status: "finished", channel: "beIN SPORTS MAX 2", commentator: "غير معروف", league: "كأس العالم", href: "/live/argentin-vs-austria" },
    { teamA: "فرنسا", teamB: "العراق", scoreA: 1, scoreB: 0, time: "22:00", status: "live", channel: "beIN SPORTS MAX 1", commentator: "غير معروف", league: "كأس العالم", href: "/live/france-vs-iraq" },
