...
export default function Home() {
  ...
  const matches = [
    ...
    { teamA: "ساحل العاج ", teamB: "الاكوادور ", scoreA: 1, scoreB: 0, itime: "00:00 ", status: "upcoming", channel: "beIN SPORTS MAX 1", commentator: "غير معروف", league: "كأس العالم", href: "/live/cotedivoire-vs-ecwador" },
    { teamA: "السويد", teamB: "تونس", scoreA: 5, scoreB: 0, time: "03:00", status: "upcoming", channel: "beIN SPORTS MAX 2", commentator: "غير معروف", league: "كأس العالم", href: "/live/swid-vs-tunis" },
