...
export default function Home() {
  const matches = [
    ...
    { teamA: " إنجلترا ", teamB: "كوستاريكا ", scoreA: 1, scoreB: 0, time: "21:00", status: "live", channel: "beIN SPORTS HD 1", commentator: "غير معروف", league: "ودية دولية", href: "/live/costarica-vs-englend" },
