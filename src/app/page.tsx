...
export default function Home() {
  ...
  const matches = [
    { teamA: "المانيا ", teamB: "كوراساو ", scoreA: 1, scoreB: 1, time: "18:00 ", status: "live", channel: "beIN SPORTS MAX 1", commentator: "غير معروف", league: "كأس العالم", href: "/live/germany-vs-corasaw" },
