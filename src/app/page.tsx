...
export default function Home() {
  const matches = [
    { teamA: "نيجيريا", teamB: "البرتغال", scoreA: 2, scoreB: 0, time: "20:45 ", status: "started", channel: "Bein Sports HD2 ", commentator: "غير معروف", league: "ودية دولية ", href: "/live/nigeria-vs-portugal" },
    { teamA: " إنجلترا ", teamB: "كوستاريكا ", scoreA: 0, scoreB: 0, time: "21:00", status: "started", channel: "beIN SPORTS HD 1", commentator: "غير معروف", league: "ودية دولية", href: "/live/costarica-vs-englend" },
