...
export default function Home() {
  ...
  const matches = [
 { teamA: "قطر", teamB: "سويسرا", scoreA: 0, scoreB: 1, jtime: "20:00", status: "live", channel: "beIN SPORTS MAX 1", commentator: "غير معروف", league: "كأس العالم", href: "/live/qatar-vs-swiss" },
